...
const SubtractionGame = () => {
  ...
  function generateQuestion() {
    const num1 = Math.floor(Math.random() * 10) + 5; // Ensure num1 is larger to avoid negative results
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Subtraction Fun 🧮</h1>
